module github.com/terapps/gonveyor/examples/publisher

go 1.24

require (
	github.com/terapps/gonveyor v0.0.0
	github.com/terapps/gonveyor/examples/factory v0.0.0
...
replace (
	...
	github.com/terapps/gonveyor/examples/factory => ../factory
